...
import static com.example.pfe.MainActivity.actionneursVentilateursAcces;

public class MyRecyclerViewAdapterVentilateurs extends RecyclerView.Adapter<MyRecyclerViewAdapterVentilateurs.ViewHolder> {


    public List<String> mData,mData2;
    private LayoutInflater mInflater;
    private MyRecyclerViewAdapterVentilateurs.ItemClickListener mClickListener;
    ...
    public MyRecyclerViewAdapterVentilateurs(Context context, List<String> data, List<String> data2) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.recyclerview_rowventilateurs, parent, false);
        return new MyRecyclerViewAdapterVentilateurs.ViewHolder(view);
    }
    // binds the data to the TextView in each row
    @Override
    public void onBindViewHolder(MyRecyclerViewAdapterVentilateurs.ViewHolder holder, int position) {
    ...
    private void changeValue(int position, String chambre, boolean checked) {
        myRef = FirebaseDatabase.getInstance().getReference().child("actionneurs/ventilateur");
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        while (iterator.hasNext()) {
                            ...
                            if (chmbr.toLowerCase().equals(chambre.toLowerCase())){
                                if (actionneursVentilateursAcces.get(position).equals("true")){
                                    if (checked==true){
                                        myRef.child(key).child("status").setValue("on");
    ...
    public void setClickListener(MyRecyclerViewAdapterVentilateurs.ItemClickListener itemClickListener) {
