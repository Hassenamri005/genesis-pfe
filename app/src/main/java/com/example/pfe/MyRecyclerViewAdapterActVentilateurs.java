...
public class MyRecyclerViewAdapterActVentilateurs extends RecyclerView.Adapter<MyRecyclerViewAdapterActVentilateurs.ViewHolder> {
    private List<String> mData, data2, data3;
    static String myId;
    static String loadsEmail;
    private LayoutInflater mInflater;
    private MyRecyclerViewAdapterActVentilateurs.ItemClickListener mClickListener;
    ...
    MyRecyclerViewAdapterActVentilateurs(Context context, List<String> data, List<String> data2, List<String> data3, String loadsEmail) {
    ...
    @Override
    public MyRecyclerViewAdapterActVentilateurs.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.recyclerview_rowactventilateurs, parent, false);
        return new MyRecyclerViewAdapterActVentilateurs.ViewHolder(view);
    }

    // binds the data to the TextView in each row
    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(MyRecyclerViewAdapterActVentilateurs.ViewHolder holder, int position) {
    ...
    private void changeValue(int position, boolean checked,String myId) {
        ...
        String path = "users/"+myId+"/Ventilateurs";
    ...
    void setClickListener(MyRecyclerViewAdapterActVentilateurs.ItemClickListener itemClickListener) {
