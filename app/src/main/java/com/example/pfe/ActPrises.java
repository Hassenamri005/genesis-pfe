...
public class ActPrises extends AppCompatActivity implements MyRecyclerViewAdapterActPrises.ItemClickListener {
    MyRecyclerViewAdapterActPrises adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new MyRecyclerViewAdapterActPrises(this, ledsNames,statusLeds,myprisesaccess,loadsEmail);
        adapter.setClickListener((MyRecyclerViewAdapterActPrises.ItemClickListener) this);
    ...
    private void changeValue(int position) {
        myRef = FirebaseDatabase.getInstance().getReference().child("users/Prises");
        Query query = myRef.orderByKey();
        query.addListenerForSingleValueEvent(
                new ValueEventListener() {
                    @Override
                        ...
                        while (iterator.hasNext()) {
                            ...
                            if (i==position){
                                if (status==true){
                                    ...
                                    com.google.firebase.database.DatabaseReference myRef = database.getReference("/actionneurs/prise");
    ...
    public void getUserInfo(){
        myRefff = mFirebaseDatabase.getReference("/actionneurs/prise");
        // Read from the database
