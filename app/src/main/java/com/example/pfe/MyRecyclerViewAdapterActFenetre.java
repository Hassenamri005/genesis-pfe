...
public class MyRecyclerViewAdapterActFenetre extends RecyclerView.Adapter<MyRecyclerViewAdapterActFenetre.ViewHolder> {
    private List<String> mData,data2,data3;
    static String myId;
    static String loadsEmail;
    private LayoutInflater mInflater;
    private MyRecyclerViewAdapterActFenetre.ItemClickListener mClickListener;
    ...
    MyRecyclerViewAdapterActFenetre(Context context, List<String> data, List<String> data2, List<String> data3, String loadsEmail) {
    ...
    @Override
    public MyRecyclerViewAdapterActFenetre.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.recyclerview_rowactfenetres, parent, false);
        return new MyRecyclerViewAdapterActFenetre.ViewHolder(view);
    }

    // binds the data to the TextView in each row
    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(MyRecyclerViewAdapterActFenetre.ViewHolder holder, int position) {
    ...
    private void changeValue(int position, boolean checked,String myId) {
        ...
        String path = "users/"+myId+"/Fenetres";
    ...
    void setClickListener(MyRecyclerViewAdapterActFenetre.ItemClickListener itemClickListener) {
