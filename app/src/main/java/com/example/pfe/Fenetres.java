...
public class Fenetres extends AppCompatActivity implements MyRecyclerViewAdapterFenetres.ItemClickListener {
    MyRecyclerViewAdapterFenetres adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fenetres);
        ...
        adapter = new MyRecyclerViewAdapterFenetres(this, chambres, statuss);
        adapter.setClickListener((MyRecyclerViewAdapterFenetres.ItemClickListener) this);
