...
public class MyRecyclerViewAdapterActLampes extends RecyclerView.Adapter<MyRecyclerViewAdapterActLampes.ViewHolder> {

    private List<String> mData,data2,data3;
    static String myId;
    static String loadsEmail;
    private LayoutInflater mInflater;
    private MyRecyclerViewAdapterActLampes.ItemClickListener mClickListener;
    ...
    MyRecyclerViewAdapterActLampes(Context context, List<String> data, List<String> data2, List<String> data3, String loadsEmail) {
    ...
    @Override
    public MyRecyclerViewAdapterActLampes.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.recyclerview_rowactlampes, parent, false);
        return new MyRecyclerViewAdapterActLampes.ViewHolder(view);
    }

    // binds the data to the TextView in each row
    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(MyRecyclerViewAdapterActLampes.ViewHolder holder, int position) {
                        ...
                        while (iterator.hasNext()) {
                            ...
                            if (key.equals(String.valueOf(position))){
                                if (checked==true){
                                    ...
                                    Log.i("haniiiiiii","haniiiiiii");
                                    Log.i("haniiiiiii 000",""+key);
                                }else{
    ...
    void setClickListener(MyRecyclerViewAdapterActLampes.ItemClickListener itemClickListener) {
